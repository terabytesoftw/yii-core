...
class FileValidator extends Validator
{
     ...
     * @param bool $trim
     */
    public function isEmpty($value, bool $trim = false): bool
    {
     ...
     * @return int
     */
    private function sizeToBytes(string $sizeStr): int
    {
     ...
     * @see mimeTypes
     */
    public function buildMimeTypeRegexp(string $mask): string
    {
